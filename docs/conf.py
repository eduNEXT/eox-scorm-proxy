...
"""
eox_scorm_proxy documentation build configuration file.
...
project = 'eox_scorm_proxy'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'eox_scorm_proxy'
...
#
# html_title = 'eox_scorm_proxy v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Plugin to proxy scorm components when using openedx-scorm-xblock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'eox_scorm_proxy'),
                os.path.join(root_path, 'eox_scorm_proxy/migrations')])
